...
/**
 * @swagger
 * /api/admin/plan-options:
 *   post:
 *     summary: Create Plan Option (ADMIN Only)
 *     tags: [Plan Options]
 *     security:
 *       - cookieAuth: []
 *     requestBody:
 ...
 *     responses:
 *       201:
 *         description: Plan option created
 *   get:
 *     summary: Get Plan Options (ADMIN Only)
 *     tags: [Plan Options]
 *     security:
 *       - cookieAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/admin/plan-options/{id}:
 *   get:
 *     summary: Get single Plan Option (ADMIN Only)
 *     tags: [Plan Options]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Option fetched
 *   put:
 *     summary: Update Plan Option (ADMIN Only)
 *     tags: [Plan Options]
 *     security:
 *       - cookieAuth: []
 *     parameters:
 ...
 *   delete:
 *     summary: Soft delete Plan Option (ADMIN Only)
 *     tags: [Plan Options]
 *     security:
 *       - cookieAuth: []
 *     parameters:
